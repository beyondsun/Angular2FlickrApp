...
@Component({
  selector: 'my-app',
  providers:[HTTP_PROVIDERS, JSONP_PROVIDERS, FlickrService],
...
export class AppComponent { 
    ...
    constructor(public http: Http, public jsonp: Jsonp, private flickrService: FlickrService){
    ...
    clickPic(id:number){
        this.currentPic = this.photos[id];
        let photoModalCon:any = $("#myPhotoModal");
        photoModalCon.modal('show');
